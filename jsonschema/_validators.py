...
class propertyNames(Validator):
    def validate(self, validator, propertyNames, instance, schema):
        if not validator.is_type(instance, "object"):
            return
...
class additionalItems(Validator):
    def validate(self, validator, aI, instance, schema):
        if (
...
class contains(Validator):
    def validate(self, validator, contains, instance, schema):
        if not validator.is_type(instance, "array"):
            return
...
class exclusiveMinimum(Validator):
    def validate(self, validator, minimum, instance, schema):
...
class multipleOf(Validator):
    def validate(self, validator, dB, instance, schema):
        if not validator.is_type(instance, "number"):
            return
...
class format(Validator):
    def validate(self, validator, format, instance, schema):
...
class minLength(Validator):
    def validate(self, validator, mL, instance, schema):
...
class dependencies(Validator):
    def validate(self, validator, dependencies, instance, schema):
        if not validator.is_type(instance, "object"):
            return
...
class enum(Validator):
    def validate(self, validator, enums, instance, schema):
...
class required(Validator):
    def validate(self, validator, required, instance, schema):
        if not validator.is_type(instance, "object"):
            return
...
class minProperties(Validator):
    def validate(self, validator, mP, instance, schema):
...
class anyOf(Validator):
    def validate(self, validator, anyOf, instance, schema):
        all_errors = []
...
class not_(Validator):
    def validate(self, validator, not_schema, instance, schema):
